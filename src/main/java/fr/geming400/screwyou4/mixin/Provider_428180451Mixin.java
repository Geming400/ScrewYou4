...
public class Provider_428180451Mixin {
    ...
    private void createParticle_815693813(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(815693813L))
    ...
    private void createParticle_1749594527(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1749594527L))
            info.setReturnValue(null);
    }
