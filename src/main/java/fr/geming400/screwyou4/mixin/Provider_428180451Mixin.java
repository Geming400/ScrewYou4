...
@Mixin(net.minecraft.client.particle.EndRodParticle.Provider.class)
public class Provider_428180451Mixin {
    ...
    private void createParticle_1124848851(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1124848851L))
    ...
    private void createParticle__2005878399(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2005878399L))
            info.setReturnValue(null);
    }
