...
public class Provider57424361Mixin {
    ...
    private void createParticle_754092762(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(754092762L))
    ...
    private void createParticle_1918332808(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1918332808L))
            info.setReturnValue(null);
    }
