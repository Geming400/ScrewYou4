...
public class DisplayMode1585880194Mixin {
    ...
    private static void values_2112861875(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2112861875L))
            info.setReturnValue(null);
    }

    @Inject(at = @At("HEAD"), method = "valueOf(Ljava/lang/String;)Lnet/minecraft/client/gui/Font$DisplayMode;", cancellable = true)
    private static void valueOf_1249844428(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1249844428L))
