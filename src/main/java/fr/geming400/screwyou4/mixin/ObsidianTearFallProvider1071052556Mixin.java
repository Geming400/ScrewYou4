...
@Mixin(net.minecraft.client.particle.DripParticle.ObsidianTearFallProvider.class)
public class ObsidianTearFallProvider1071052556Mixin {
    ...
    private void createParticle_1458565919(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1458565919L))
    ...
    private void createParticle__1902500663(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1902500663L))
            info.setReturnValue(null);
    }
