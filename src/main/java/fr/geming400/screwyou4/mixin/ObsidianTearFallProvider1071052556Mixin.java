...
public class ObsidianTearFallProvider1071052556Mixin {
    ...
    private void createParticle_1767720957(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1767720957L))
    ...
    private void createParticle__1363006293(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1363006293L))
            info.setReturnValue(null);
    }
