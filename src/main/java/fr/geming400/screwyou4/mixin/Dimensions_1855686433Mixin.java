...
public class Dimensions_1855686433Mixin {
    ...
    private void left__750343841(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-750343841L))
            info.setReturnValue(-1860627926);
    }
