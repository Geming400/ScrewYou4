...
@Mixin(net.minecraft.client.particle.FlyTowardsPositionParticle.EnchantProvider.class)
public class EnchantProvider_733634042Mixin {
    ...
    private void createParticle_1430302442(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1430302442L))
    ...
    private void createParticle__1700424808(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1700424808L))
            info.setReturnValue(null);
    }
