...
public class EnchantProvider_733634042Mixin {
    ...
    private void createParticle_1121147404(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1121147404L))
    ...
    private void createParticle_2055048118(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2055048118L))
            info.setReturnValue(null);
    }
