...
public class PaleOakProvider166534719Mixin {
    ...
    private void createParticle_863203120(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(863203120L))
    ...
    private void createParticle_2027443166(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2027443166L))
            info.setReturnValue(null);
    }
