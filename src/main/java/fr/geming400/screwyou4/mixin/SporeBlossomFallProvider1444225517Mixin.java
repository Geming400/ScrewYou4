...
public class SporeBlossomFallProvider1444225517Mixin {
    ...
    private void createParticle_2140893918(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2140893918L))
    ...
    private void createParticle__989833332(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-989833332L))
            info.setReturnValue(null);
    }
