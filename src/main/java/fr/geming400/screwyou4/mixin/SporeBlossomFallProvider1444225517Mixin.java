...
@Mixin(net.minecraft.client.particle.DripParticle.SporeBlossomFallProvider.class)
public class SporeBlossomFallProvider1444225517Mixin {
    ...
    private void createParticle_1831738880(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1831738880L))
    ...
    private void createParticle__1529327702(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1529327702L))
            info.setReturnValue(null);
    }
