...
public class BridgeCrossing_66107282Mixin {
    ...
    private static void createPiece_1624190941(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1624190941L))
    ...
    private void addChildren_782783787(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(782783787L))
            info.cancel();
    }
    ...
    private void postProcess__610251039(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-610251039L))
            info.cancel();
    }
