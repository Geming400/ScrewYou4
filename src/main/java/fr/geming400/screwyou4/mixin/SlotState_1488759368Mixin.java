...
public class SlotState_1488759368Mixin {
    ...
    private static void values__1970521837(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1970521837L))
    ...
    private static void valueOf__205318548(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-205318548L))
