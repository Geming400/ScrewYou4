...
public class SlabBlock2131282469Mixin {
    ...
    private void codec__1097239573(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1097239573L))
    ...
    private void canPlaceLiquid_2098712568(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2098712568L))
            info.setReturnValue(true);
    }
