...
@Mixin(net.minecraft.client.particle.LargeSmokeParticle.Provider.class)
public class Provider900173461Mixin {
    ...
    private void createParticle_1287686824(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1287686824L))
    ...
    private void createParticle__2073379758(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2073379758L))
            info.setReturnValue(null);
    }
