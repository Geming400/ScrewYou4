...
public class Provider900173461Mixin {
    ...
    private void createParticle_1596841862(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1596841862L))
    ...
    private void createParticle__1533885388(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1533885388L))
            info.setReturnValue(null);
    }
