...
@Mixin(net.minecraft.client.particle.FireworkParticles.SparkProvider.class)
public class SparkProvider1623060170Mixin {
    ...
    private void createParticle_2010573533(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2010573533L))
    ...
    private void createParticle__1350493049(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1350493049L))
            info.setReturnValue(null);
    }
