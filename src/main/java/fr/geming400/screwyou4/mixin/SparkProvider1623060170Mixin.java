...
public class SparkProvider1623060170Mixin {
    ...
    private void createParticle__1975238725(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1975238725L))
    ...
    private void createParticle__810998679(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-810998679L))
            info.setReturnValue(null);
    }
