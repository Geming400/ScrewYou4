...
public class SetWritableBookPagesFunction_266047553Mixin {
    ...
    private void apply_2137305599(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2137305599L))
            info.setReturnValue(null);
    }

    @Inject(at = @At("HEAD"), method = "codec()Lcom/mojang/serialization/MapCodec;", cancellable = true)
    private void codec_2001901276(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2001901276L))
            info.setReturnValue(null);
    }
