...
public class GlowInkProvider_1281918936Mixin {
    ...
    private void createParticle_1978587336(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1978587336L))
    ...
    private void createParticle__1152139914(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1152139914L))
            info.setReturnValue(null);
    }
