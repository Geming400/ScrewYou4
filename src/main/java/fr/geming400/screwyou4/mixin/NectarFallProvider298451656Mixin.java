...
@Mixin(net.minecraft.client.particle.DripParticle.NectarFallProvider.class)
public class NectarFallProvider298451656Mixin {
    ...
    private void createParticle_685965019(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(685965019L))
    ...
    private void createParticle_1619865733(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1619865733L))
            info.setReturnValue(null);
    }
