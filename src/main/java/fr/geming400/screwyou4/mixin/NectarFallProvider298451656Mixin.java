...
public class NectarFallProvider298451656Mixin {
    ...
    private void createParticle_995120057(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(995120057L))
    ...
    private void createParticle__2135607193(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2135607193L))
            info.setReturnValue(null);
    }
