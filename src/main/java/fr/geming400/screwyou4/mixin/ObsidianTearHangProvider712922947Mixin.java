...
@Mixin(net.minecraft.client.particle.DripParticle.ObsidianTearHangProvider.class)
public class ObsidianTearHangProvider712922947Mixin {
    ...
    private void createParticle_1409591348(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1409591348L))
    ...
    private void createParticle__1721135902(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1721135902L))
            info.setReturnValue(null);
    }
