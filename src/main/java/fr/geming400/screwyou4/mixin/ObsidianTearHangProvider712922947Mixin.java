...
public class ObsidianTearHangProvider712922947Mixin {
    ...
    private void createParticle_1100436310(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1100436310L))
    ...
    private void createParticle_2034337024(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2034337024L))
            info.setReturnValue(null);
    }
