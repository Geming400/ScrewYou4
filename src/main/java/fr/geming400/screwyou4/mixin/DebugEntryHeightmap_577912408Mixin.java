...
@Mixin(net.minecraft.client.gui.components.debug.DebugEntryHeightmap.class)
public class DebugEntryHeightmap_577912408Mixin {
    ...
    private void display__1497936709(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1497936709L))
            info.cancel();
    }
