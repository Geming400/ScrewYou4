...
@Mixin(net.minecraft.client.particle.SplashParticle.Provider.class)
public class Provider493861058Mixin {
    ...
    private void createParticle_1190529459(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1190529459L))
    ...
    private void createParticle__1940197791(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1940197791L))
            info.setReturnValue(null);
    }
