...
public class Provider619025276Mixin {
    ...
    private void createParticle_1006538639(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1006538639L))
    ...
    private void createParticle_1940439353(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1940439353L))
            info.setReturnValue(null);
    }
