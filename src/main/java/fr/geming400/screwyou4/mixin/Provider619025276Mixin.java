...
@Mixin(net.minecraft.client.particle.HugeExplosionSeedParticle.Provider.class)
public class Provider619025276Mixin {
    ...
    private void createParticle_1315693677(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1315693677L))
    ...
    private void createParticle__1815033573(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1815033573L))
            info.setReturnValue(null);
    }
