...
@Mixin(net.minecraft.world.item.WrittenBookItem.class)
public class WrittenBookItem1912588997Mixin {
    ...
    private void use__1972002264(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1972002264L))
