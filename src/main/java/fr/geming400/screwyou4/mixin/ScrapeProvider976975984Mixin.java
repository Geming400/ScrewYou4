...
@Mixin(net.minecraft.client.particle.GlowParticle.ScrapeProvider.class)
public class ScrapeProvider976975984Mixin {
    ...
    private void createParticle_1673644385(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1673644385L))
    ...
    private void createParticle__1457082865(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1457082865L))
            info.setReturnValue(null);
    }
