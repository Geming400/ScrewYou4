...
public class Provider_884091543Mixin {
    ...
    private void createParticle_1580759943(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1580759943L))
    ...
    private void createParticle__1549967307(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1549967307L))
            info.setReturnValue(null);
    }
