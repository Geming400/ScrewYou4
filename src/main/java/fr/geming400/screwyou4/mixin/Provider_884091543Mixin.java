...
@Mixin(net.minecraft.client.particle.GustSeedParticle.Provider.class)
public class Provider_884091543Mixin {
    ...
    private void createParticle_1271604905(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1271604905L))
    ...
    private void createParticle__2089461677(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2089461677L))
            info.setReturnValue(null);
    }
