...
public class Provider_889882756Mixin {
    ...
    private void createParticle_1277396118(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1277396118L))
    ...
    private void createParticle__2083670464(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2083670464L))
            info.setReturnValue(null);
    }
