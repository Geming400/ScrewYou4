...
public class UnihexProvider1858708124Mixin {
    ...
    private void getSupportedGlyphs__974484104(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-974484104L))
            info.setReturnValue(null);
    }

    @Inject(at = @At("HEAD"), method = "getGlyph(I)Lcom/mojang/blaze3d/font/UnbakedGlyph;", cancellable = true)
    private void getGlyph_1071977548(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1071977548L))
            info.setReturnValue(null);
    }
