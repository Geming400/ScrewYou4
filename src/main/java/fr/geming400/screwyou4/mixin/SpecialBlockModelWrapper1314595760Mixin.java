...
@Mixin(net.minecraft.client.renderer.block.model.SpecialBlockModelWrapper.class)
public class SpecialBlockModelWrapper1314595760Mixin {
    ...
    private void update_1925478602(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(1925478602L))
            info.cancel();
    }
