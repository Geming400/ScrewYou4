...
@Mixin(net.minecraft.client.particle.AttackSweepParticle.Provider.class)
public class Provider1285464787Mixin {
    ...
    private void createParticle_1982133188(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1982133188L))
    ...
    private void createParticle__1148594062(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1148594062L))
            info.setReturnValue(null);
    }
