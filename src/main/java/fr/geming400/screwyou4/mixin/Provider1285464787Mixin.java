...
public class Provider1285464787Mixin {
    ...
    private void createParticle_1672978150(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1672978150L))
    ...
    private void createParticle__1688088432(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1688088432L))
            info.setReturnValue(null);
    }
