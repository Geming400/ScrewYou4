...
public class DyeItem_1897813099Mixin {
    ...
    private void interactLivingEntity_853589477(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(853589477L))
    ...
    private void tryApplyToSign_1882181127(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1882181127L))
