...
@Mixin(net.minecraft.client.particle.CritParticle.Provider.class)
public class Provider_473060177Mixin {
    ...
    private void createParticle_1169728577(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1169728577L))
    ...
    private void createParticle__1960998673(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1960998673L))
            info.setReturnValue(null);
    }
