...
public class Provider_473060177Mixin {
    ...
    private void createParticle_860573539(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(860573539L))
    ...
    private void createParticle_1794474253(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1794474253L))
            info.setReturnValue(null);
    }
