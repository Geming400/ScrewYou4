...
public class WolfArmorLayer_1035906356Mixin {
    ...
    private void submit_1771574195(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(1771574195L))
            info.cancel();
    }
    ...
    private void submit_578142724(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(578142724L))
            info.cancel();
    }
