...
@Mixin(net.minecraft.client.renderer.entity.layers.WolfArmorLayer.class)
public class WolfArmorLayer_1035906356Mixin {
    ...
    private void submit_2117615563(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(2117615563L))
            info.cancel();
    }
    ...
    private void submit__1883551716(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1883551716L))
            info.cancel();
    }
