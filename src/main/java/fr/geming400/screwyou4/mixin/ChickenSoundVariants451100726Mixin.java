...
public class ChickenSoundVariants451100726Mixin {
    ...
    private static void bootstrap__741417777(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-741417777L))
            info.cancel();
    }
    ...
    private static void pickRandomSoundVariant_163124208(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(163124208L))
