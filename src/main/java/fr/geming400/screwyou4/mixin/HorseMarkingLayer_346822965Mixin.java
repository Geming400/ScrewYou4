...
public class HorseMarkingLayer_346822965Mixin {
    ...
    private void submit_878072921(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(878072921L))
            info.cancel();
    }
    ...
    private void submit__110940667(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-110940667L))
            info.cancel();
    }
