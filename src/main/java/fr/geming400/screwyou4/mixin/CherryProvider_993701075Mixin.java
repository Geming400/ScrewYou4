...
@Mixin(net.minecraft.client.particle.FallingLeavesParticle.CherryProvider.class)
public class CherryProvider_993701075Mixin {
    ...
    private void createParticle_1690369475(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1690369475L))
    ...
    private void createParticle__1440357775(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1440357775L))
            info.setReturnValue(null);
    }
