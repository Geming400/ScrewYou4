...
public class CherryProvider_993701075Mixin {
    ...
    private void createParticle_1381214437(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1381214437L))
    ...
    private void createParticle__1979852145(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1979852145L))
            info.setReturnValue(null);
    }
