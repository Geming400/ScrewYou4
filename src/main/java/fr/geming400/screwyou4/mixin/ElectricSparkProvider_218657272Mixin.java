...
@Mixin(net.minecraft.client.particle.GlowParticle.ElectricSparkProvider.class)
public class ElectricSparkProvider_218657272Mixin {
    ...
    private void createParticle_606170634(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(606170634L))
    ...
    private void createParticle_1540071348(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1540071348L))
            info.setReturnValue(null);
    }
