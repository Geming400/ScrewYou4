...
public class EntityBasedExplosionDamageCalculator_843878312Mixin {
    ...
    private void shouldBlockExplode__1512301337(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1512301337L))
    ...
    private void getBlockExplosionResistance__1577499058(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1577499058L))
