...
@Mixin(net.minecraft.client.particle.DripParticle.WaterFallProvider.class)
public class WaterFallProvider1208732834Mixin {
    ...
    private void createParticle_1905401235(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1905401235L))
    ...
    private void createParticle__1225326015(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1225326015L))
            info.setReturnValue(null);
    }
