...
public class WaterFallProvider1208732834Mixin {
    ...
    private void createParticle_1596246197(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1596246197L))
    ...
    private void createParticle__1764820385(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1764820385L))
            info.setReturnValue(null);
    }
