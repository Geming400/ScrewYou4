...
@Mixin(net.minecraft.client.particle.ReversePortalParticle.ReversePortalProvider.class)
public class ReversePortalProvider475085193Mixin {
    ...
    private void createParticle_1171753594(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1171753594L))
    ...
    private void createParticle__1958973656(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1958973656L))
            info.setReturnValue(null);
    }
