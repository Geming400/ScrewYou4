...
public class ReversePortalProvider475085193Mixin {
    ...
    private void createParticle_862598556(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(862598556L))
    ...
    private void createParticle_1796499270(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1796499270L))
            info.setReturnValue(null);
    }
