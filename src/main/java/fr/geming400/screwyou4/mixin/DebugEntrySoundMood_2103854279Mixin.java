...
@Mixin(net.minecraft.client.gui.components.debug.DebugEntrySoundMood.class)
public class DebugEntrySoundMood_2103854279Mixin {
    ...
    private void display__1159560084(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1159560084L))
            info.cancel();
    }
