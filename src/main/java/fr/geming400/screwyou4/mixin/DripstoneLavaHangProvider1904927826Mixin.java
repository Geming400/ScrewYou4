...
@Mixin(net.minecraft.client.particle.DripParticle.DripstoneLavaHangProvider.class)
public class DripstoneLavaHangProvider1904927826Mixin {
    ...
    private void createParticle__2002526107(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2002526107L))
    ...
    private void createParticle__1068625393(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1068625393L))
            info.setReturnValue(null);
    }
