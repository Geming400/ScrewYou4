...
public class DripstoneLavaHangProvider1904927826Mixin {
    ...
    private void createParticle__1693371069(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1693371069L))
    ...
    private void createParticle__529131023(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-529131023L))
            info.setReturnValue(null);
    }
