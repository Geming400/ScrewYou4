...
public class Provider_465266094Mixin {
    ...
    private void createParticle_1161934494(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1161934494L))
    ...
    private void createParticle__1968792756(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1968792756L))
            info.setReturnValue(null);
    }
