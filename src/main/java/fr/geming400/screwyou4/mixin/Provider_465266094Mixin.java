...
@Mixin(net.minecraft.client.particle.BubblePopParticle.Provider.class)
public class Provider_465266094Mixin {
    ...
    private void createParticle_852779456(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(852779456L))
    ...
    private void createParticle_1786680170(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1786680170L))
            info.setReturnValue(null);
    }
