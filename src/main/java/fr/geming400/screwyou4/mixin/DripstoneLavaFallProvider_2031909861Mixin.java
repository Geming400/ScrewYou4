...
@Mixin(net.minecraft.client.particle.DripParticle.DripstoneLavaFallProvider.class)
public class DripstoneLavaFallProvider_2031909861Mixin {
    ...
    private void createParticle__1566389035(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1566389035L))
    ...
    private void createParticle__402148989(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-402148989L))
            info.setReturnValue(null);
    }
