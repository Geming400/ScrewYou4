...
public class DripstoneLavaFallProvider_2031909861Mixin {
    ...
    private void createParticle__1875544073(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1875544073L))
    ...
    private void createParticle__941643359(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-941643359L))
            info.setReturnValue(null);
    }
