...
public class BreezeWindLayer_1437236672Mixin {
    ...
    private void submit__1218252536(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1218252536L))
            info.cancel();
    }
    ...
    private void submit_979473040(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(979473040L))
            info.cancel();
    }
