...
@Mixin(net.minecraft.client.renderer.entity.layers.SimpleEquipmentLayer.class)
public class SimpleEquipmentLayer_1070452291Mixin {
    ...
    private void submit__1849005781(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1849005781L))
            info.cancel();
    }
    ...
    private void submit__1077916428(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1077916428L))
            info.cancel();
    }
