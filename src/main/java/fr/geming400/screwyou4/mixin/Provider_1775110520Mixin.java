...
public class Provider_1775110520Mixin {
    ...
    private void createParticle__1253111525(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1253111525L))
    ...
    private void createParticle__658948330(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-658948330L))
            info.setReturnValue(null);
    }
