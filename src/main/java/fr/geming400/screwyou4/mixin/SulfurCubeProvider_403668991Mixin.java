...
public class SulfurCubeProvider_403668991Mixin {
    ...
    private void createParticle_791182353(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(791182353L))
    ...
    private void createParticle_1725083067(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1725083067L))
            info.setReturnValue(null);
    }
