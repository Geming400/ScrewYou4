...
@Mixin(net.minecraft.client.particle.BreakingItemParticle.SulfurCubeProvider.class)
public class SulfurCubeProvider_403668991Mixin {
    ...
    private void createParticle_1100337391(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1100337391L))
    ...
    private void createParticle__2030389859(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2030389859L))
            info.setReturnValue(null);
    }
