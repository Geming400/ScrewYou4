...
@Mixin(net.minecraft.client.particle.CritParticle.MagicProvider.class)
public class MagicProvider844263170Mixin {
    ...
    private void createParticle_1540931571(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1540931571L))
    ...
    private void createParticle__1589795679(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1589795679L))
            info.setReturnValue(null);
    }
