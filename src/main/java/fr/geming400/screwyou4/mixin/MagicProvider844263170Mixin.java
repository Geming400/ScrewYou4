...
public class MagicProvider844263170Mixin {
    ...
    private void createParticle_1231776533(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1231776533L))
    ...
    private void createParticle__2129290049(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2129290049L))
            info.setReturnValue(null);
    }
