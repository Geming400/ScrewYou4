...
public class SnowballProvider620131957Mixin {
    ...
    private void createParticle_1007645320(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1007645320L))
    ...
    private void createParticle_1941546034(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1941546034L))
            info.setReturnValue(null);
    }
