...
@Mixin(net.minecraft.client.particle.BreakingItemParticle.SnowballProvider.class)
public class SnowballProvider620131957Mixin {
    ...
    private void createParticle_1316800358(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1316800358L))
    ...
    private void createParticle__1813926892(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1813926892L))
            info.setReturnValue(null);
    }
