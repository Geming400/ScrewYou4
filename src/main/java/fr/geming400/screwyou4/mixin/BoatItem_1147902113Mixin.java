...
@Mixin(net.minecraft.world.item.BoatItem.class)
public class BoatItem_1147902113Mixin {
    ...
    private void use__1662198244(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1662198244L))
