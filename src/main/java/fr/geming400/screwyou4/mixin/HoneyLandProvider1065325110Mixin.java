...
@Mixin(net.minecraft.client.particle.DripParticle.HoneyLandProvider.class)
public class HoneyLandProvider1065325110Mixin {
    ...
    private void createParticle_1452838473(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1452838473L))
    ...
    private void createParticle__1908228109(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1908228109L))
            info.setReturnValue(null);
    }
