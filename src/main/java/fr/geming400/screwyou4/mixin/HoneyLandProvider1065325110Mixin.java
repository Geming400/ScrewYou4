...
public class HoneyLandProvider1065325110Mixin {
    ...
    private void createParticle_1761993511(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1761993511L))
    ...
    private void createParticle__1368733739(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1368733739L))
            info.setReturnValue(null);
    }
