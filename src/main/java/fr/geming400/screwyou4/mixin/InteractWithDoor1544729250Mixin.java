...
public class InteractWithDoor1544729250Mixin {
    ...
    private static void create__1644855762(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1644855762L))
    ...
    private static void closeDoorsThatIHaveOpenedOrPassedThrough_1730571762(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(1730571762L))
            info.cancel();
    }
