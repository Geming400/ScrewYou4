...
public class ComponentRenderUtils2036262776Mixin {
    ...
    private static void wrapComponents__1019679507(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1019679507L))
    ...
    private static void clipText__2141640229(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2141640229L))
            info.setReturnValue(null);
    }
