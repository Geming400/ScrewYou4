...
public class SheepWoolLayer_634339127Mixin {
    ...
    private void submit_1336342617(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(1336342617L))
            info.cancel();
    }
    ...
    private void submit_176575495(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(176575495L))
            info.cancel();
    }
