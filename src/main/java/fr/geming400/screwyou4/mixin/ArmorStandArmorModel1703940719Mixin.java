...
public class ArmorStandArmorModel1703940719Mixin {
    ...
    private static void createArmorLayerSet_651323857(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(651323857L))
    ...
    private void setupAnim__871734149(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-871734149L))
            info.cancel();
    }
