...
public class DebugStickItem1664519324Mixin {
    ...
    private void useOn_749402091(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(749402091L))
    ...
    private void canDestroyBlock_897323949(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(897323949L))
