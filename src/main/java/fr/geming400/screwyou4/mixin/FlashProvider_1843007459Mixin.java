...
public class FlashProvider_1843007459Mixin {
    ...
    private void createParticle_1951754715(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1951754715L))
    ...
    private void createParticle__591051391(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-591051391L))
            info.setReturnValue(null);
    }
