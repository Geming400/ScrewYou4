...
public class CrossedArmsItemLayer1461265872Mixin {
    ...
    private void submit_1003502241(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(1003502241L))
            info.cancel();
    }
    ...
    private void submit__719837090(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-719837090L))
            info.cancel();
    }
