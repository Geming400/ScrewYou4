...
@Mixin(net.minecraft.client.particle.DripParticle.DripstoneWaterHangProvider.class)
public class DripstoneWaterHangProvider_1874245235Mixin {
    ...
    private void createParticle__2033208699(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2033208699L))
    ...
    private void createParticle__1099307985(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1099307985L))
            info.setReturnValue(null);
    }
