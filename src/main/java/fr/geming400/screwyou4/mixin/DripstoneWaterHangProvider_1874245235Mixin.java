...
public class DripstoneWaterHangProvider_1874245235Mixin {
    ...
    private void createParticle__1724053661(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1724053661L))
    ...
    private void createParticle__559813615(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-559813615L))
            info.setReturnValue(null);
    }
