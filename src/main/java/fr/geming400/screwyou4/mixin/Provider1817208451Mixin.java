...
@Mixin(net.minecraft.client.particle.PlayerCloudParticle.Provider.class)
public class Provider1817208451Mixin {
    ...
    private void createParticle__2090245482(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2090245482L))
    ...
    private void createParticle__1156344768(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1156344768L))
            info.setReturnValue(null);
    }
