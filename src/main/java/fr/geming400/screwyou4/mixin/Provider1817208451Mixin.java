...
public class Provider1817208451Mixin {
    ...
    private void createParticle__1781090444(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1781090444L))
    ...
    private void createParticle__616850398(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-616850398L))
            info.setReturnValue(null);
    }
