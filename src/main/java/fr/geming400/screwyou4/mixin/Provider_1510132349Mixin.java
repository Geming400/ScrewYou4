...
public class Provider_1510132349Mixin {
    ...
    private void createParticle_1897645711(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1897645711L))
    ...
    private void createParticle__1463420871(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1463420871L))
            info.setReturnValue(null);
    }
