...
@Mixin(net.minecraft.client.particle.WhiteSmokeParticle.Provider.class)
public class Provider_1510132349Mixin {
    ...
    private void createParticle__2088166547(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2088166547L))
    ...
    private void createParticle__923926501(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-923926501L))
            info.setReturnValue(null);
    }
