...
public class Provider226218218Mixin {
    ...
    private void createParticle_613731581(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(613731581L))
    ...
    private void createParticle_1547632295(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1547632295L))
            info.setReturnValue(null);
    }
