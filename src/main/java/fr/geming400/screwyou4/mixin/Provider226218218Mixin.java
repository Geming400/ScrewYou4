...
@Mixin(net.minecraft.client.particle.SuspendedTownParticle.Provider.class)
public class Provider226218218Mixin {
    ...
    private void createParticle_922886619(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(922886619L))
    ...
    private void createParticle_2087126665(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2087126665L))
            info.setReturnValue(null);
    }
