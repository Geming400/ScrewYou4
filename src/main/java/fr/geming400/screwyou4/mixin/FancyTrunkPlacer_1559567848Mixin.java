...
@Mixin(net.minecraft.world.level.levelgen.feature.trunkplacers.FancyTrunkPlacer.class)
public class FancyTrunkPlacer_1559567848Mixin {
    ...
    private void placeTrunk__1242501045(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1242501045L))
