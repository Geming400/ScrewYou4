...
public class ByIdMap1069770492Mixin {
    ...
    private static void sparse__923677591(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-923677591L))
    ...
    private static void continuous_1351923312(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1351923312L))
            info.setReturnValue(null);
    }
