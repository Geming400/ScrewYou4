...
@Mixin(net.minecraft.client.particle.SpellParticle.Provider.class)
public class Provider_348694033Mixin {
    ...
    private void createParticle_736207395(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(736207395L))
    ...
    private void createParticle_1670108109(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1670108109L))
            info.setReturnValue(null);
    }
