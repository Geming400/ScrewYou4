...
public class Provider_348694033Mixin {
    ...
    private void createParticle_1045362433(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1045362433L))
    ...
    private void createParticle__2085364817(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2085364817L))
            info.setReturnValue(null);
    }
