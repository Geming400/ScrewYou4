...
public class WeatheringCopperGrateBlock1087282897Mixin {
    ...
    private void getAge__890666317(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-890666317L))
            info.setReturnValue(null);
    }

    @Inject(at = @At("HEAD"), method = "getAge()Lnet/minecraft/world/level/block/WeatheringCopper$WeatherState;", cancellable = true)
    private void getAge_286045072(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(286045072L))
