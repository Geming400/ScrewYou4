...
@Mixin(net.minecraft.client.particle.SulfurBubbleParticle.Provider.class)
public class Provider767839940Mixin {
    ...
    private void createParticle_1155353303(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1155353303L))
    ...
    private void createParticle_2089254017(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2089254017L))
            info.setReturnValue(null);
    }
