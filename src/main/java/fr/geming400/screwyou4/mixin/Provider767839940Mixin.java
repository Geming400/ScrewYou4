...
public class Provider767839940Mixin {
    ...
    private void createParticle_1464508341(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1464508341L))
    ...
    private void createParticle__1666218909(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1666218909L))
            info.setReturnValue(null);
    }
