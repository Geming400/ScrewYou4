...
public class SneezeProvider370385673Mixin {
    ...
    private void createParticle_757899036(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(757899036L))
    ...
    private void createParticle_1691799750(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1691799750L))
            info.setReturnValue(null);
    }
