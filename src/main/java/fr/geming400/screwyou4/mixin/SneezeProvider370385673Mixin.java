...
@Mixin(net.minecraft.client.particle.PlayerCloudParticle.SneezeProvider.class)
public class SneezeProvider370385673Mixin {
    ...
    private void createParticle_1067054074(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1067054074L))
    ...
    private void createParticle__2063673176(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2063673176L))
            info.setReturnValue(null);
    }
