...
public class GlowSquidProvider1537407661Mixin {
    ...
    private void createParticle_1924921024(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1924921024L))
    ...
    private void createParticle__1436145558(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1436145558L))
            info.setReturnValue(null);
    }
