...
public class Provider163170973Mixin {
    ...
    private void createParticle_550684336(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(550684336L))
    ...
    private void createParticle_1484585050(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1484585050L))
            info.setReturnValue(null);
    }
