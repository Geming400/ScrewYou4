...
@Mixin(net.minecraft.client.particle.AshParticle.Provider.class)
public class Provider2062955425Mixin {
    ...
    private void createParticle__1844498508(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1844498508L))
    ...
    private void createParticle__910597794(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-910597794L))
            info.setReturnValue(null);
    }
