...
public class Provider2062955425Mixin {
    ...
    private void createParticle__1535343470(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1535343470L))
    ...
    private void createParticle__371103424(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-371103424L))
            info.setReturnValue(null);
    }
