...
public class Template1980579590Mixin {
    ...
    private void type_942330147(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(942330147L))
    ...
    private void instantiate__1486757708(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1486757708L))
            info.setReturnValue(null);
    }
    ...
    private void instantiate_174256599(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(174256599L))
            info.setReturnValue(null);
    }
