...
public class ServerboundContainerClickPacket_591688116Mixin {
    ...
    private void slotNum_629959971(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(629959971L))
            info.setReturnValue((short) 31566);
    }
