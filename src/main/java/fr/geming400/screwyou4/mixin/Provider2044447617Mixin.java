...
@Mixin(net.minecraft.client.particle.SpitParticle.Provider.class)
public class Provider2044447617Mixin {
    ...
    private void createParticle__1863006316(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1863006316L))
    ...
    private void createParticle__929105602(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-929105602L))
            info.setReturnValue(null);
    }
