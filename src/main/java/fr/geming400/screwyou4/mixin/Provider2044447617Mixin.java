...
public class Provider2044447617Mixin {
    ...
    private void createParticle__1553851278(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1553851278L))
    ...
    private void createParticle__389611232(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-389611232L))
            info.setReturnValue(null);
    }
