...
public class BrewingStandBlock_137424951Mixin {
    ...
    private void codec_1873278674(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1873278674L))
    ...
    private void animateTick_14822869(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(14822869L))
            info.cancel();
    }
