...
public class WaxOffProvider_625173219Mixin {
    ...
    private void createParticle_1012686581(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1012686581L))
    ...
    private void createParticle_1946587295(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1946587295L))
            info.setReturnValue(null);
    }
