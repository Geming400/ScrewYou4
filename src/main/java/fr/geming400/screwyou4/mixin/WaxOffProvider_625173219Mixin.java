...
@Mixin(net.minecraft.client.particle.GlowParticle.WaxOffProvider.class)
public class WaxOffProvider_625173219Mixin {
    ...
    private void createParticle_1321841619(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1321841619L))
    ...
    private void createParticle__1808885631(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1808885631L))
            info.setReturnValue(null);
    }
