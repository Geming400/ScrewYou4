...
@Mixin(net.minecraft.client.particle.SuspendedParticle.SporeBlossomAirProvider.class)
public class SporeBlossomAirProvider_65296012Mixin {
    ...
    private void createParticle_761964412(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(761964412L))
    ...
    private void createParticle_1926204458(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1926204458L))
            info.setReturnValue(null);
    }
