...
public class CatSoundVariants933479909Mixin {
    ...
    private static void bootstrap__259038594(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-259038594L))
            info.cancel();
    }
    ...
    private static void pickRandomSoundVariant_645503391(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(645503391L))
