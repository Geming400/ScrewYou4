...
@Mixin(net.minecraft.client.gui.components.debug.DebugEntryPostEffect.class)
public class DebugEntryPostEffect_1428581056Mixin {
    ...
    private void display__1834833307(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1834833307L))
            info.cancel();
    }
