...
public class PigSoundVariants44865035Mixin {
    ...
    private static void bootstrap__509740682(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-509740682L))
            info.cancel();
    }
    ...
    private static void pickRandomSoundVariant_52664491(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(52664491L))
