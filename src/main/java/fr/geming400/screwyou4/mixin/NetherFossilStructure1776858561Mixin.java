...
public class NetherFossilStructure1776858561Mixin {
    ...
    private void type_631257093(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(631257093L))
    ...
    private void findGenerationPoint_1776189539(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1776189539L))
            info.setReturnValue(null);
    }
