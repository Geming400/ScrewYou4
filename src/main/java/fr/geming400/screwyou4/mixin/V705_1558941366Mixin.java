...
public class V705_1558941366Mixin {
    ...
    private void registerTypes_1520721022(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(1520721022L))
            info.cancel();
    }

    @Inject(at = @At("HEAD"), method = "registerEntities(Lcom/mojang/datafixers/schemas/Schema;)Ljava/util/Map;", cancellable = true)
    private void registerEntities_895655397(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(895655397L))
