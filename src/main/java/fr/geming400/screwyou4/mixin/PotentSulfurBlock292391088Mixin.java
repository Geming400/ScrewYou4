...
public class PotentSulfurBlock292391088Mixin {
    ...
    private void codec_2028244812(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2028244812L))
    ...
    private void getStateForPlacement__966208679(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-966208679L))
            info.setReturnValue(null);
    }
