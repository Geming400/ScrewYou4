...
public class MonsterThrone_1657860539Mixin {
    ...
    private static void createPiece__368613571(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-368613571L))
    ...
    private void postProcess__562562405(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-562562405L))
            info.cancel();
    }
