...
public class Provider240453169Mixin {
    ...
    private void createParticle_937121570(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(937121570L))
    ...
    private void createParticle_2101361616(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2101361616L))
            info.setReturnValue(null);
    }
