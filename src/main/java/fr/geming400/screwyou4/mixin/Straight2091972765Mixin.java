...
public class Straight2091972765Mixin {
    ...
    private void addChildren__1958130569(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1958130569L))
            info.cancel();
    }
    ...
    private static void createPiece__507589692(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-507589692L))
    ...
    private void postProcess__128450178(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-128450178L))
            info.cancel();
    }
