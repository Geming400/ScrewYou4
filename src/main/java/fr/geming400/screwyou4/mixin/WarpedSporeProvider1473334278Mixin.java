...
public class WarpedSporeProvider1473334278Mixin {
    ...
    private void createParticle_1860847641(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1860847641L))
    ...
    private void createParticle__1500218941(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1500218941L))
            info.setReturnValue(null);
    }
