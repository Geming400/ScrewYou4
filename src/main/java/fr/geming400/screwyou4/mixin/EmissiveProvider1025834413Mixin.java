...
public class EmissiveProvider1025834413Mixin {
    ...
    private void createParticle_1413347776(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1413347776L))
    ...
    private void createParticle__1947718806(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1947718806L))
            info.setReturnValue(null);
    }
