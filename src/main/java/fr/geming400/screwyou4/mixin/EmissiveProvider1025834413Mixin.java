...
@Mixin(net.minecraft.client.particle.SoulParticle.EmissiveProvider.class)
public class EmissiveProvider1025834413Mixin {
    ...
    private void createParticle_1722502814(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1722502814L))
    ...
    private void createParticle__1408224436(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1408224436L))
            info.setReturnValue(null);
    }
