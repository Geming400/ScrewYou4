...
public class Axis_1956437388Mixin {
    ...
    private static void values__657610579(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-657610579L))
    ...
    private static void valueOf_1268915462(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1268915462L))
