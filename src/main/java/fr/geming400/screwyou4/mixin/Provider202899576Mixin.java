...
public class Provider202899576Mixin {
    ...
    private void createParticle_590412939(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(590412939L))
    ...
    private void createParticle_1524313653(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1524313653L))
            info.setReturnValue(null);
    }
