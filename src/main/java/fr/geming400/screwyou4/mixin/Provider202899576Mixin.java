...
@Mixin(net.minecraft.client.particle.DustPlumeParticle.Provider.class)
public class Provider202899576Mixin {
    ...
    private void createParticle_899567977(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(899567977L))
    ...
    private void createParticle_2063808023(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2063808023L))
            info.setReturnValue(null);
    }
