...
@Mixin(net.minecraft.client.particle.GustParticle.Provider.class)
public class Provider505338010Mixin {
    ...
    private void createParticle_1202006411(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1202006411L))
    ...
    private void createParticle__1928720839(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1928720839L))
            info.setReturnValue(null);
    }
