...
public class Provider505338010Mixin {
    ...
    private void createParticle_892851373(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(892851373L))
    ...
    private void createParticle_1826752087(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1826752087L))
            info.setReturnValue(null);
    }
