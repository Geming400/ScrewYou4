...
public class Provider1199742117Mixin {
    ...
    private void createParticle_1587255480(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1587255480L))
    ...
    private void createParticle__1773811102(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1773811102L))
            info.setReturnValue(null);
    }
