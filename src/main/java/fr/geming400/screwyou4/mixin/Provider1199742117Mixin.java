...
@Mixin(net.minecraft.client.particle.WakeParticle.Provider.class)
public class Provider1199742117Mixin {
    ...
    private void createParticle_1896410518(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1896410518L))
    ...
    private void createParticle__1234316732(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1234316732L))
            info.setReturnValue(null);
    }
