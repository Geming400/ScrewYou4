...
public class CobwebProvider1526961105Mixin {
    ...
    private void createParticle__2071337790(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2071337790L))
    ...
    private void createParticle__907097744(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-907097744L))
            info.setReturnValue(null);
    }
