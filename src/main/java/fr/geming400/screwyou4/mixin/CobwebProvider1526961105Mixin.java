...
@Mixin(net.minecraft.client.particle.BreakingItemParticle.CobwebProvider.class)
public class CobwebProvider1526961105Mixin {
    ...
    private void createParticle_1914474468(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1914474468L))
    ...
    private void createParticle__1446592114(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1446592114L))
            info.setReturnValue(null);
    }
