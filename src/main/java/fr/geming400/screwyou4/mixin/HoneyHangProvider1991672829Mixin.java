...
@Mixin(net.minecraft.client.particle.DripParticle.HoneyHangProvider.class)
public class HoneyHangProvider1991672829Mixin {
    ...
    private void createParticle__1606626066(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1606626066L))
    ...
    private void createParticle__442386020(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-442386020L))
            info.setReturnValue(null);
    }
