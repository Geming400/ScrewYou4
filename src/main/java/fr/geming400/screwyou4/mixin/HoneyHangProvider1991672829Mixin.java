...
public class HoneyHangProvider1991672829Mixin {
    ...
    private void createParticle__1915781104(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1915781104L))
    ...
    private void createParticle__981880390(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-981880390L))
            info.setReturnValue(null);
    }
