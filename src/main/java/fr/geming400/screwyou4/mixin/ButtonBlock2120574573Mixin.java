...
public class ButtonBlock2120574573Mixin {
    ...
    private void codec__1107947469(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1107947469L))
    ...
    private void press__1854073044(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1854073044L))
            info.cancel();
    }
