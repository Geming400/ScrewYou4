...
public class BookSpecialRenderer_2057695963Mixin {
    ...
    private void submit__185951420(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-185951420L))
            info.cancel();
    }

    @Inject(at = @At("HEAD"), method = "getExtents(Ljava/util/function/Consumer;)V", cancellable = true)
    private void getExtents_1717927114(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(1717927114L))
            info.cancel();
    }
