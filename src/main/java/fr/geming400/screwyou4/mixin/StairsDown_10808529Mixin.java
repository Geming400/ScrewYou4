...
public class StairsDown_10808529Mixin {
    ...
    private static void createPiece__1281114477(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1281114477L))
    ...
    private void addChildren_727485034(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(727485034L))
            info.cancel();
    }
    ...
    private void postProcess__665549792(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-665549792L))
            info.cancel();
    }
