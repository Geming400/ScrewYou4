...
public class BlockUtil873079361Mixin {
    ...
    private static void getTopConnectedBlock_1828221466(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1828221466L))
    ...
    private static void getLargestRectangleAround__2126024147(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2126024147L))
            info.setReturnValue(null);
    }
