...
@Mixin(net.minecraft.client.particle.SuspendedTownParticle.ComposterFillProvider.class)
public class ComposterFillProvider842059179Mixin {
    ...
    private void createParticle_1229572542(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1229572542L))
    ...
    private void createParticle__2131494040(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2131494040L))
            info.setReturnValue(null);
    }
