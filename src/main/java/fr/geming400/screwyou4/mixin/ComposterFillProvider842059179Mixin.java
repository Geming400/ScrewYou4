...
public class ComposterFillProvider842059179Mixin {
    ...
    private void createParticle_1538727580(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1538727580L))
    ...
    private void createParticle__1591999670(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1591999670L))
            info.setReturnValue(null);
    }
