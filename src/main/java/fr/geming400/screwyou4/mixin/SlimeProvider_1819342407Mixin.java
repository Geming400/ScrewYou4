...
@Mixin(net.minecraft.client.particle.BreakingItemParticle.SlimeProvider.class)
public class SlimeProvider_1819342407Mixin {
    ...
    private void createParticle__2088111527(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2088111527L))
    ...
    private void createParticle__1154210813(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1154210813L))
            info.setReturnValue(null);
    }
