...
public class SlimeProvider_1819342407Mixin {
    ...
    private void createParticle__1778956489(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1778956489L))
    ...
    private void createParticle__614716443(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-614716443L))
            info.setReturnValue(null);
    }
