...
@Mixin(net.minecraft.client.particle.SuspendedParticle.UnderwaterProvider.class)
public class UnderwaterProvider19585275Mixin {
    ...
    private void createParticle_716253676(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(716253676L))
    ...
    private void createParticle_1880493722(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1880493722L))
            info.setReturnValue(null);
    }
