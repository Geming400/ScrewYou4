...
public class UnderwaterProvider19585275Mixin {
    ...
    private void createParticle_407098638(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(407098638L))
    ...
    private void createParticle_1340999352(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1340999352L))
            info.setReturnValue(null);
    }
