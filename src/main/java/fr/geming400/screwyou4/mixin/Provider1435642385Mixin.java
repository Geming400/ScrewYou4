...
public class Provider1435642385Mixin {
    ...
    private void createParticle_2132310786(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2132310786L))
    ...
    private void createParticle__998416464(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-998416464L))
            info.setReturnValue(null);
    }
