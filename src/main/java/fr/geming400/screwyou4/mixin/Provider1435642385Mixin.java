...
@Mixin(net.minecraft.client.particle.HeartParticle.Provider.class)
public class Provider1435642385Mixin {
    ...
    private void createParticle_1823155748(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1823155748L))
    ...
    private void createParticle__1537910834(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1537910834L))
            info.setReturnValue(null);
    }
