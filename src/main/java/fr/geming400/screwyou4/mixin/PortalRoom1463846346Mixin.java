...
public class PortalRoom1463846346Mixin {
    ...
    private static void createPiece__652563736(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-652563736L))
    ...
    private void addChildren_1708710308(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(1708710308L))
            info.cancel();
    }
    ...
    private void postProcess__756576597(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-756576597L))
            info.cancel();
    }
