...
@Mixin(net.minecraft.client.particle.WaterCurrentDownParticle.Provider.class)
public class Provider_2054096731Mixin {
    ...
    private void createParticle__1544202165(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1544202165L))
    ...
    private void createParticle__379962119(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-379962119L))
            info.setReturnValue(null);
    }
