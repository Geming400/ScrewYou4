...
public class Provider_2054096731Mixin {
    ...
    private void createParticle__1853357203(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1853357203L))
    ...
    private void createParticle__919456489(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-919456489L))
            info.setReturnValue(null);
    }
