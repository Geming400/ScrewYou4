...
public class Builder1244531Mixin {
    ...
    private void build__366380925(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-366380925L))
    ...
    private void addTab_687809449(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(687809449L))
            info.setReturnValue(null);
    }
