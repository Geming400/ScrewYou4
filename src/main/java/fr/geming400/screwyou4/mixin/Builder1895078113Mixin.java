...
public class Builder1895078113Mixin {
    ...
    private void build__236368359(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-236368359L))
    ...
    private void addRestriction_1745650160(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1745650160L))
            info.setReturnValue(new net.minecraft.client.multiplayer.chat.ChatAbilities.Builder());
    }
