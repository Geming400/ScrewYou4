...
public class BlockType1882471900Mixin {
    ...
    private static void values_1634585291(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1634585291L))
    ...
    private static void valueOf_1200492718(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1200492718L))
            info.setReturnValue(null);
    }
