...
public class TemplatePathFactory_1365823363Mixin {
    ...
    private void createAndValidatePathToStructure__347893288(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-347893288L))
    ...
    private void createAndValidatePathToStructure_1210793761(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1210793761L))
            info.setReturnValue(null);
    }
