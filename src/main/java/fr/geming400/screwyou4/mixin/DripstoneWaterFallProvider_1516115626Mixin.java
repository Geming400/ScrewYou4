...
public class DripstoneWaterFallProvider_1516115626Mixin {
    ...
    private void createParticle__2082183270(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2082183270L))
    ...
    private void createParticle__917943224(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-917943224L))
            info.setReturnValue(null);
    }
