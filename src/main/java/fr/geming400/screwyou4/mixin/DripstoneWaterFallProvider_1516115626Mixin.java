...
@Mixin(net.minecraft.client.particle.DripParticle.DripstoneWaterFallProvider.class)
public class DripstoneWaterFallProvider_1516115626Mixin {
    ...
    private void createParticle_1903628988(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1903628988L))
    ...
    private void createParticle__1457437594(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1457437594L))
            info.setReturnValue(null);
    }
