...
@Mixin(net.minecraft.client.renderer.entity.layers.SpinAttackEffectLayer.class)
public class SpinAttackEffectLayer86669032Mixin {
    ...
    private void submit_1990575623(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(1990575623L))
            info.cancel();
    }
    ...
    private void submit_1462178257(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(1462178257L))
            info.cancel();
    }
