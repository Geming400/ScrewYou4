...
public class SpinAttackEffectLayer86669032Mixin {
    ...
    private void submit_157302767(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(157302767L))
            info.cancel();
    }
    ...
    private void submit__371094599(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-371094599L))
            info.cancel();
    }
