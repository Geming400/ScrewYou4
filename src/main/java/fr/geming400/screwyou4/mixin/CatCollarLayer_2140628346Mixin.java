...
public class CatCollarLayer_2140628346Mixin {
    ...
    private void submit_1778355327(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(1778355327L))
            info.cancel();
    }
    ...
    private void submit__778829726(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-778829726L))
            info.cancel();
    }
