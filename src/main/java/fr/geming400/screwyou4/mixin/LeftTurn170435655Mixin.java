...
public class LeftTurn170435655Mixin {
    ...
    private void postProcess__2049987288(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-2049987288L))
            info.cancel();
    }
    ...
    private void addChildren_415299617(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(415299617L))
            info.cancel();
    }
    ...
    private static void createPiece__1867235068(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1867235068L))
