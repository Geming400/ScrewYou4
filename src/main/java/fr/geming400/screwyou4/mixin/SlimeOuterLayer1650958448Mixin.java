...
public class SlimeOuterLayer1650958448Mixin {
    ...
    private void submit__1092882264(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1092882264L))
            info.cancel();
    }
    ...
    private void submit__1268499623(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1268499623L))
            info.cancel();
    }
