...
public class PlayerSpawnFinder795517202Mixin {
    ...
    private static void findSpawn_798421538(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(798421538L))
    ...
    private static void getSpawnPosInChunk__327751953(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-327751953L))
            info.setReturnValue(null);
    }
