...
public class ParrotOnShoulderLayer1217493550Mixin {
    ...
    private void submit_759729919(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(759729919L))
            info.cancel();
    }
    ...
    private void submit_1288127285(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(1288127285L))
            info.cancel();
    }
