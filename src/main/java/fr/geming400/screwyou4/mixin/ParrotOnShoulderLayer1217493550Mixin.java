...
@Mixin(net.minecraft.client.renderer.entity.layers.ParrotOnShoulderLayer.class)
public class ParrotOnShoulderLayer1217493550Mixin {
    ...
    private void submit__1701964521(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1701964521L))
            info.cancel();
    }
    ...
    private void submit__1173567155(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1173567155L))
            info.cancel();
    }
