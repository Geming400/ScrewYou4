...
@Mixin(net.minecraft.client.particle.FlyStraightTowardsParticle.OminousSpawnProvider.class)
public class OminousSpawnProvider_1457478229Mixin {
    ...
    private void createParticle_1844991591(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1844991591L))
    ...
    private void createParticle__1516074991(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1516074991L))
            info.setReturnValue(null);
    }
