...
public class OminousSpawnProvider_1457478229Mixin {
    ...
    private void createParticle__2140820667(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2140820667L))
    ...
    private void createParticle__976580621(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-976580621L))
            info.setReturnValue(null);
    }
