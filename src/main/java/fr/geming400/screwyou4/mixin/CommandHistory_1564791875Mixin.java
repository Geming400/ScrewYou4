...
public class CommandHistory_1564791875Mixin {
    ...
    private void history__579644346(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-579644346L))
            info.setReturnValue(null);
    }

    @Inject(at = @At("HEAD"), method = "addCommand(Ljava/lang/String;)V", cancellable = true)
    private void addCommand__1501001643(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1501001643L))
            info.cancel();
    }
