...
@Mixin(net.minecraft.client.particle.SpellParticle.WitchProvider.class)
public class WitchProvider1889038172Mixin {
    ...
    private void createParticle__2018415761(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2018415761L))
    ...
    private void createParticle__1084515047(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1084515047L))
            info.setReturnValue(null);
    }
