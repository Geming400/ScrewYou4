...
public class WitchProvider1889038172Mixin {
    ...
    private void createParticle__1709260723(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1709260723L))
    ...
    private void createParticle__545020677(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-545020677L))
            info.setReturnValue(null);
    }
