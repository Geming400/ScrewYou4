...
@Mixin(net.minecraft.client.particle.HeartParticle.AngryVillagerProvider.class)
public class AngryVillagerProvider_1005721158Mixin {
    ...
    private void createParticle_1393234520(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1393234520L))
    ...
    private void createParticle__1967832062(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1967832062L))
            info.setReturnValue(null);
    }
