...
public class AngryVillagerProvider_1005721158Mixin {
    ...
    private void createParticle_1702389558(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1702389558L))
    ...
    private void createParticle__1428337692(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1428337692L))
            info.setReturnValue(null);
    }
