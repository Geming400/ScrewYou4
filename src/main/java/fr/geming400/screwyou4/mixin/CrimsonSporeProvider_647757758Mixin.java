...
@Mixin(net.minecraft.client.particle.SuspendedParticle.CrimsonSporeProvider.class)
public class CrimsonSporeProvider_647757758Mixin {
    ...
    private void createParticle_1035271120(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1035271120L))
    ...
    private void createParticle_1969171834(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1969171834L))
            info.setReturnValue(null);
    }
