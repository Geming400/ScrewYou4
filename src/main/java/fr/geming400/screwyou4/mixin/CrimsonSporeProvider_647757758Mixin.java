...
public class CrimsonSporeProvider_647757758Mixin {
    ...
    private void createParticle_1344426158(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1344426158L))
    ...
    private void createParticle__1786301092(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1786301092L))
            info.setReturnValue(null);
    }
