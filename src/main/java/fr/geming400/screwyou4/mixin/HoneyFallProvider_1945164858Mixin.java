...
@Mixin(net.minecraft.client.particle.DripParticle.HoneyFallProvider.class)
public class HoneyFallProvider_1945164858Mixin {
    ...
    private void createParticle__1962289076(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1962289076L))
    ...
    private void createParticle__1028388362(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1028388362L))
            info.setReturnValue(null);
    }
