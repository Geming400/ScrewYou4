...
public class HoneyFallProvider_1945164858Mixin {
    ...
    private void createParticle__1653134038(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1653134038L))
    ...
    private void createParticle__488893992(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-488893992L))
            info.setReturnValue(null);
    }
