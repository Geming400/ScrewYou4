...
@Mixin(net.minecraft.client.particle.HugeExplosionParticle.Provider.class)
public class Provider2140575789Mixin {
    ...
    private void createParticle__1766878144(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1766878144L))
    ...
    private void createParticle__832977430(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-832977430L))
            info.setReturnValue(null);
    }
