...
public class Provider2140575789Mixin {
    ...
    private void createParticle__1457723106(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1457723106L))
    ...
    private void createParticle__293483060(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-293483060L))
            info.setReturnValue(null);
    }
