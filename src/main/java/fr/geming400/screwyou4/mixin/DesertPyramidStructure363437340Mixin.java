...
public class DesertPyramidStructure363437340Mixin {
    ...
    private void type__782164128(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-782164128L))
    ...
    private void afterPlace__1444013237(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1444013237L))
            info.cancel();
    }
