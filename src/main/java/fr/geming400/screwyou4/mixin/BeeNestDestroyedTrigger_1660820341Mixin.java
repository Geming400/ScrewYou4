...
public class BeeNestDestroyedTrigger_1660820341Mixin {
    ...
    private void trigger__2005771012(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-2005771012L))
            info.cancel();
    }

    @Inject(at = @At("HEAD"), method = "codec()Lcom/mojang/serialization/Codec;", cancellable = true)
    private void codec_1268854714(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1268854714L))
