...
public class CocoaBlock_1035135224Mixin {
    ...
    private void codec__1523978349(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1523978349L))
    ...
    private void isBonemealSuccess__937777920(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-937777920L))
