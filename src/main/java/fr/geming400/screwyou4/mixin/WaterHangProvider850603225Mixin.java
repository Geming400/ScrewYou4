...
@Mixin(net.minecraft.client.particle.DripParticle.WaterHangProvider.class)
public class WaterHangProvider850603225Mixin {
    ...
    private void createParticle_1238116588(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1238116588L))
    ...
    private void createParticle__2122949994(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2122949994L))
            info.setReturnValue(null);
    }
