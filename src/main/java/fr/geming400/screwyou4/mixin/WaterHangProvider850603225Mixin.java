...
public class WaterHangProvider850603225Mixin {
    ...
    private void createParticle_1547271626(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1547271626L))
    ...
    private void createParticle__1583455624(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1583455624L))
            info.setReturnValue(null);
    }
