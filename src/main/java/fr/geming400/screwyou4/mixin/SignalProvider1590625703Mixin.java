...
public class SignalProvider1590625703Mixin {
    ...
    private void createParticle__2007673192(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2007673192L))
    ...
    private void createParticle__843433146(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-843433146L))
            info.setReturnValue(null);
    }
