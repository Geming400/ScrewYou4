...
@Mixin(net.minecraft.client.particle.CampfireSmokeParticle.SignalProvider.class)
public class SignalProvider1590625703Mixin {
    ...
    private void createParticle_1978139066(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1978139066L))
    ...
    private void createParticle__1382927516(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1382927516L))
            info.setReturnValue(null);
    }
