...
@Mixin(net.minecraft.client.particle.WhiteAshParticle.Provider.class)
public class Provider_1174014564Mixin {
    ...
    private void createParticle_1870682964(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1870682964L))
    ...
    private void createParticle__1260044286(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1260044286L))
            info.setReturnValue(null);
    }
