...
public class Provider_1174014564Mixin {
    ...
    private void createParticle_1561527926(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1561527926L))
    ...
    private void createParticle__1799538656(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1799538656L))
            info.setReturnValue(null);
    }
