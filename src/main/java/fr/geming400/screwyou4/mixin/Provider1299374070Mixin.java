...
public class Provider1299374070Mixin {
    ...
    private void createParticle_1996042471(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1996042471L))
    ...
    private void createParticle__1134684779(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1134684779L))
            info.setReturnValue(null);
    }
