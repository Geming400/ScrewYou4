...
public class NetherFortressStructure_309107857Mixin {
    ...
    private void type__836493612(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-836493612L))
    ...
    private void findGenerationPoint_308438834(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(308438834L))
            info.setReturnValue(null);
    }
