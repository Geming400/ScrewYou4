...
public class CapeLayer_396293136Mixin {
    ...
    private void submit_1771802360(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(1771802360L))
            info.cancel();
    }
    ...
    private void submit__1994767570(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1994767570L))
            info.cancel();
    }
