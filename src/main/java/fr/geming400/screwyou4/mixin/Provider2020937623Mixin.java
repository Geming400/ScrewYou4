...
public class Provider2020937623Mixin {
    ...
    private void createParticle__1577361272(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1577361272L))
    ...
    private void createParticle__413121226(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-413121226L))
            info.setReturnValue(null);
    }
