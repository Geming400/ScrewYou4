...
@Mixin(net.minecraft.client.particle.NoteParticle.Provider.class)
public class Provider2020937623Mixin {
    ...
    private void createParticle__1886516310(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1886516310L))
    ...
    private void createParticle__952615596(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-952615596L))
            info.setReturnValue(null);
    }
