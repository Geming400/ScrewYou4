...
@Mixin(net.minecraft.client.particle.CritParticle.DamageIndicatorProvider.class)
public class DamageIndicatorProvider_683471563Mixin {
    ...
    private void createParticle_1380139963(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1380139963L))
    ...
    private void createParticle__1750587287(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1750587287L))
            info.setReturnValue(null);
    }
