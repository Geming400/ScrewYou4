...
public class DamageIndicatorProvider_683471563Mixin {
    ...
    private void createParticle_1070984925(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1070984925L))
    ...
    private void createParticle_2004885639(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2004885639L))
            info.setReturnValue(null);
    }
