...
@Mixin(net.minecraft.client.gui.components.debug.DebugEntryChunkGeneration.class)
public class DebugEntryChunkGeneration353991864Mixin {
    ...
    private void display__1721857252(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1721857252L))
            info.cancel();
    }
