...
public class SmallProvider564003025Mixin {
    ...
    private void createParticle_951516388(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(951516388L))
    ...
    private void createParticle_1885417102(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1885417102L))
            info.setReturnValue(null);
    }
