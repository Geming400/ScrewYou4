...
@Mixin(net.minecraft.client.particle.GustParticle.SmallProvider.class)
public class SmallProvider564003025Mixin {
    ...
    private void createParticle_1260671426(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1260671426L))
    ...
    private void createParticle__1870055824(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1870055824L))
            info.setReturnValue(null);
    }
