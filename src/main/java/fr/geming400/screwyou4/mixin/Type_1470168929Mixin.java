...
public class Type_1470168929Mixin {
    ...
    private static void values__1317035361(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1317035361L))
            info.setReturnValue(null);
    }

    @Inject(at = @At("HEAD"), method = "valueOf(Ljava/lang/String;)Lnet/minecraft/world/item/CreativeModeTab$Type;", cancellable = true)
    private static void valueOf_1028412472(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1028412472L))
