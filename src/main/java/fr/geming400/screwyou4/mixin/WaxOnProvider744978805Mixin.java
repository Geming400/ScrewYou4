...
@Mixin(net.minecraft.client.particle.GlowParticle.WaxOnProvider.class)
public class WaxOnProvider744978805Mixin {
    ...
    private void createParticle_1132492168(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1132492168L))
    ...
    private void createParticle_2066392882(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2066392882L))
            info.setReturnValue(null);
    }
