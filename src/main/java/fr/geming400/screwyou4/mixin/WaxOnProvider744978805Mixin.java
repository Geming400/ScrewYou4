...
public class WaxOnProvider744978805Mixin {
    ...
    private void createParticle_1441647206(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1441647206L))
    ...
    private void createParticle__1689080044(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1689080044L))
            info.setReturnValue(null);
    }
