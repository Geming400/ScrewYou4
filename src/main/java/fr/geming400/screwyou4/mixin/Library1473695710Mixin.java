...
public class Library1473695710Mixin {
    ...
    private void postProcess_797337390(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(797337390L))
            info.cancel();
    }
    ...
    private static void createPiece_150583446(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(150583446L))
