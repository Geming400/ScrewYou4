...
@Mixin(net.minecraft.client.gui.components.debug.DebugEntryBiome.class)
public class DebugEntryBiome810306995Mixin {
    ...
    private void display__1265542121(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(-1265542121L))
            info.cancel();
    }
