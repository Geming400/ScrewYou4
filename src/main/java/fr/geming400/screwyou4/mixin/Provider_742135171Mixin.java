...
public class Provider_742135171Mixin {
    ...
    private void createParticle_1129648533(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1129648533L))
    ...
    private void createParticle_2063549247(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2063549247L))
            info.setReturnValue(null);
    }
