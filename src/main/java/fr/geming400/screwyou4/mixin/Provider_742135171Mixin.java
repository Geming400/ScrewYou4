...
@Mixin(net.minecraft.client.particle.BubbleParticle.Provider.class)
public class Provider_742135171Mixin {
    ...
    private void createParticle_1438803571(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1438803571L))
    ...
    private void createParticle__1691923679(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1691923679L))
            info.setReturnValue(null);
    }
