...
@Mixin(net.minecraft.client.particle.FireflyParticle.FireflyProvider.class)
public class FireflyProvider973723815Mixin {
    ...
    private void createParticle_1361237178(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1361237178L))
    ...
    private void createParticle__1999829404(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1999829404L))
            info.setReturnValue(null);
    }
