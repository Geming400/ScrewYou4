...
public class FireflyProvider973723815Mixin {
    ...
    private void createParticle_1670392216(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1670392216L))
    ...
    private void createParticle__1460335034(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1460335034L))
            info.setReturnValue(null);
    }
