...
@Mixin(net.minecraft.client.particle.SuspendedTownParticle.DolphinSpeedProvider.class)
public class DolphinSpeedProvider_850973997Mixin {
    ...
    private void createParticle_1547642397(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1547642397L))
    ...
    private void createParticle__1583084853(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1583084853L))
            info.setReturnValue(null);
    }
