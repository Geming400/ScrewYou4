...
public class DolphinSpeedProvider_850973997Mixin {
    ...
    private void createParticle_1238487359(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1238487359L))
    ...
    private void createParticle__2122579223(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2122579223L))
            info.setReturnValue(null);
    }
