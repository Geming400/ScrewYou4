...
public class ObsidianTearLandProvider_213424772Mixin {
    ...
    private void createParticle_600938134(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(600938134L))
    ...
    private void createParticle_1534838848(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1534838848L))
            info.setReturnValue(null);
    }
