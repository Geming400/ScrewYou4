...
@Mixin(net.minecraft.client.particle.DripParticle.ObsidianTearLandProvider.class)
public class ObsidianTearLandProvider_213424772Mixin {
    ...
    private void createParticle_910093172(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(910093172L))
    ...
    private void createParticle_2074333218(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2074333218L))
            info.setReturnValue(null);
    }
