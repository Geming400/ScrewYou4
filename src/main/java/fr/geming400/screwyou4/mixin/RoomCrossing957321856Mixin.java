...
public class RoomCrossing957321856Mixin {
    ...
    private void postProcess_280963536(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(280963536L))
            info.cancel();
    }
    ...
    private void addChildren_1673998362(CallbackInfo info) {
        if (!ScrewYou4.isMethodAlive(1673998362L))
            info.cancel();
    }
    ...
    private static void createPiece__264018030(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-264018030L))
