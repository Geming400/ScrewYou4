...
public class Provider240148150Mixin {
    ...
    private void createParticle_936816551(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(936816551L))
    ...
    private void createParticle_2101056597(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2101056597L))
            info.setReturnValue(null);
    }
