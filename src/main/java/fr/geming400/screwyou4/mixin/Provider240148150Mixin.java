...
@Mixin(net.minecraft.client.particle.TotemParticle.Provider.class)
public class Provider240148150Mixin {
    ...
    private void createParticle_627661513(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(627661513L))
    ...
    private void createParticle_1561562227(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1561562227L))
            info.setReturnValue(null);
    }
