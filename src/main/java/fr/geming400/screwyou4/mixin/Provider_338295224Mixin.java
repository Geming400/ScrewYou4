...
public class Provider_338295224Mixin {
    ...
    private void createParticle_1034963624(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1034963624L))
    ...
    private void createParticle__2095763626(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-2095763626L))
            info.setReturnValue(null);
    }
