...
@Mixin(net.minecraft.client.particle.SmokeParticle.Provider.class)
public class Provider_338295224Mixin {
    ...
    private void createParticle_725808586(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(725808586L))
    ...
    private void createParticle_1659709300(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1659709300L))
            info.setReturnValue(null);
    }
