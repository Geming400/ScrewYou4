...
public class CosyProvider768290193Mixin {
    ...
    private void createParticle_1464958594(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1464958594L))
    ...
    private void createParticle__1665768656(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(-1665768656L))
            info.setReturnValue(null);
    }
