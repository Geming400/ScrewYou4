...
@Mixin(net.minecraft.client.particle.CampfireSmokeParticle.CosyProvider.class)
public class CosyProvider768290193Mixin {
    ...
    private void createParticle_1155803556(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(1155803556L))
    ...
    private void createParticle_2089704270(CallbackInfoReturnable<Object> info) {
        if (!ScrewYou4.isMethodAlive(2089704270L))
            info.setReturnValue(null);
    }
